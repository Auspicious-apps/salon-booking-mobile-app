...
class SalonTreatmentController extends Controller
{
    ...
    public function insert_treatment(Request $request)
    {
        ...
        // $data = $request->input('staff_member_name');
        // die($data);
        ...
        //$treatment_insert->staff_member_id = $request->input('staff_member_name');
    ...
    public function add_treatment_category(Request $request)
    {
                ...
                $treatment_insert->staff_member_id = $staff_member_id;
                $treatment_insert->treatment_identify = str_replace(" ","-",$saloon_treatment);
    ...
    /*
     * delete category treatment
     *
    */
    public function delete_treatment_category(Request $request) {

            $delete_treatment_id = $request->input('delete_treatment_id');
                $treatment_id = SalonTreatment::find($delete_treatment_id);
                $treatment_id->delete();

            return  $delete_treatment_id; 
    }
