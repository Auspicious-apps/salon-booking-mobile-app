                        ...
                        if(salooncategory == ''){
                           ...
                           return false;
                            ...
                            $.ajax({
                                    ...
                                    data:{salooncategory:salooncategory,saloon_treatment:saloon_treatment,price:price,set_hours:set_hours,set_minute:set_minute},
                                        success:function(data){
                                         
                                            $('.insert-treatment').prop('disabled', false);
                                            
                                                    swal("Treatment Added!", "success");
                                                    $("#modalseven").css("display", "none");
                                                
                                                setTimeout(function(){
                                                
                                                    window.location = "{{ url('get-salon') }}";
                    ...
                    $.ajax({
                        ...
                        data:{overview_startcustomerCalender:overview_startcustomerCalender,overview_endcustomerCalender:overview_endcustomerCalender},
                            ...
                            success:function(data){
                                 ...
                                 $("#loading-image").hide();
                                $('#overview_startcustomerCalender').val('');
                                $('#overview_endcustomerCalender').val('');
                                var json_obj =  $.parseJSON(data);
                                
                                    var test = json_obj.customerdata;
                                        var output='';
                                            output +='<tr class="heading">'; 
                                            output +='<th>Appointment No.</th>'; 
                                            output +='<th>Name Of Customer</th>'; 
                                            output +='<th>Date & Time Of Appointment</th>';
                                             output +='<th>Appointed Hairdresser</th>';
                                            output +='</tr>'; 
                                    $.each(test, function(index, element) {
                                        output +='<tr>'; 
                                        output += '<td>'+element.appointment_no+'</td>';
                                        output += '<td>'+element.customer_name+'</td>';
                                        output += '<td>'+element.customerTime+' '+element.customerDate+'</td>';
                                        output += '<td>'+element.appointedHairdresser+'</td>';
                                        output +='</tr>'; 
