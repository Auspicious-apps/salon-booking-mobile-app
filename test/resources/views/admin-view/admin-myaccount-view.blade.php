  ...
  <div class="content-wrapper">
    ...
    <div class="staff-block">
      <div class="staff-heading content-header">
         ...
         <a href="{{ url('admin-edit-myaccount') }}"<button type="button" class="admin_editMyaccount">Edit <img src="dist/img/edit.png"></button></a>
         </div>
      </div> 
    </div>
        ...
        <div class="information-right">
                  ...
                  <div class="basic-info-block ">             
                    ...
                    <ul>
                      <li><span>City</span><span>@if(!empty($getAdmin_Data->city)) {{ $getAdmin_Data->city }} @endif, @if(!empty($getAdmin_Data->state)) {{ $getAdmin_Data->state }} @endif</span></li>
                      <li><span>Street Address</span><span>@if(!empty($getAdmin_Data->street_address)) {{ $getAdmin_Data->street_address }} @endif</span></li>
                      <li><span>Zip/Postal Code</span><span>@if(!empty($getAdmin_Data->zipcode)) {{ $getAdmin_Data->zipcode }} @endif</span></li>   
                    </ul>
                  </div>
                    <div class="basic-info-block"> 
                       ...
                       <!--  <div class="otherPages" data-modal="modaltwo">
                        ...
                        <div class="basic-info-block new-basic">
                            <ul>
                              ...
                              <li><span>Email Address</span><span>@if(!empty($getAdmin_Data->email)) {{ $getAdmin_Data->email }} @endif</span></li>
                              <li><span>Phone Number</span><span>@if(!empty($getAdmin_Data->phone)) {{ $getAdmin_Data->phone }} @endif</span></li>
                          </ul>
                        </div>
                      </div>
                    </div>
