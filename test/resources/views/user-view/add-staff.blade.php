      ...
      <div class="metting-schedule add-staff-grid">
        ...
        <div class="staff-right-block">
            ...
            @enderror
             ...
             <div class="coll">
              <input placeholder="Date of Birth"  value="{{old('dob')}}" name="dob" class="textbox-n" type="text" onfocus="(this.type='date')" id="date">
               @error('dob')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div> 
            ...
            <div class="coll">
                <input type="text"  value="{{ old('position') }}" id="position" name="position" placeholder="position">
                  @error('position')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div>
            ...
            <div class="coll">
              <input type="text" id="contact_number"  value="{{ old('contact_number') }}" name="contact_number" placeholder="Contact Number">
            @error('contact_number')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div>
            <div class="coll">
              <input type="text" id="email_address"  value="{{ old('email_address') }}" name="email_address"  placeholder="Email Address">
            @error('email_address')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div>         
            <div class="coll">
              <input type="text" id="home_address"  value="{{ old('home_address') }}"  name="home_address" placeholder="Home Address">
               @error('home_address')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            </div>
             ...
             <div class="coll">
              <input type="text" id="city"  value="{{ old('city') }}"  name="city" placeholder="City">
                @error('city')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="coll">
              <input type="text" id="state"  value="{{ old('state') }}"  name="state" placeholder="State">
                @error('state')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-add-main">
                <div class="coll">
                 <h6>From</h6>
                 <input placeholder="From"  value="{{old('vacationStaf_from')}}" class="textbox-n" type="text"  name="vacationStaf_from" onfocus="(this.type='date')" id="from">
                ...
                <div class="coll">
                    <h6>To</h6>
                 <input placeholder="To"  value="{{old('vacationStaff_To')}}" class="textbox-n" type="text"  name="vacationStaff_To" onfocus="(this.type='date')" id="to">
               ...
               <div class="coll">
                 <input type="submit" name="add_staffButton" id="handleAjax" value="submit">
               </div>
            </div>
