          ...
          <section class="filters">
            ...
            <div>
              ...
              <div data-content class="is-active" id="salon">
                ...
                <div class="information-right">
                  ...
                  <div class="otherPages" data-modal="modalfive">
                            <div class="appoinment edit">
                              <a href="{{ url('add-salon') }}">Edit<img src="dist/img/edit.png"></a>
                            </div>
                        </div>
                      </div>
                  ...
                  <div class="basic-info-block ">             
                    ...
                    <ul>
                      <li><span>City</span><span><?php  if(!empty($getSalonUserDetails->city)) { echo $getSalonUserDetails->city; } ?></span></li>
                      <li><span>Street Address</span><span><?php  if(!empty($getSalonUserDetails->address)) { echo $getSalonUserDetails->address; } ?></span></li> 
                      <li><span>Zip/Postal Code</span><span><?php  if(!empty($getSalonUserDetails->zipcode)) { echo $getSalonUserDetails->zipcode; } ?></span></li>
                      <li><span>Open Timing</span><span><?php  if(!empty($getSalonUserDetails->opening_timing)) { echo $getSalonUserDetails->opening_timing; } ?></span></li>
                      <li><span>Close Timing</span><span><?php  if(!empty($getSalonUserDetails->closing_timing)) { echo $getSalonUserDetails->closing_timing; } ?></span></li>
                    </ul>
                  </div>
                    <div class="basic-info-block"> 
                      <div class="edit-option">
                       ...
                       <!--  <div class="otherPages" data-modal="modaltwo">
                        ...
                        <div class="basic-info-block new-basic">
                            <ul>
                              <li><span>Email Address</span><span>{{ $getDetailsUser->email }}</span></li>
                              <li><span>Phone Number</span><span>{{ $getDetailsUser->phone }}</span></li>
                          </ul>
                        </div>
                      </div>
                    </div> 
              ...
              <div data-content id="treatments">
                ...
                <div class="otherPages new_page-add" data-modal="modalseven">
                            <div class="appoinment edit">
                ...
                <div class="modal-content">
                    <div class="modal-header header-top block">
                      ...
                      <div class="category-form new-form">
                        <div class="left-form">
                          ...
                          <input type="text" class="left" name="saloon_treatment" id="saloon_treatment" placeholder="Name of the Treatment">
                        </form>
                      </div>
                    ...
                    <div class="right-form">
                          ...
                          <input type="text" id="set_hours" class="left" placeholder="Set Hours">
                          <input type="text" class="left" id="set_minute" placeholder="Set Minute">
                            
                       
                    </div>
                      </div>
                      <div class="modal-footer center category-pop">
                         <button type="button" class="update-btn-test insert-treatment" data-dismiss="modal" aria-hidden="true">Add</button>
                         <button type="button" class="close-btn close close-button">Cancel</button>
                ...
                <div class="services_boxes">
                    <h3> Men </h3>
                      @foreach($getSalonTreatment as $data)
                        ...
                        <div class="otherPages" data-modal="modalnine_{{ $data->id }}"><span class="icon"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="right-form">
                        <form>
                              ...
                              <select name="salooncategory" id="salooncategory-{{ $data->id }}">
                                <option value="">Select any category</option>
                                <option value="men" {{ ( $data->treatment_category == "men") ? 'selected' : '' }}>Men</option>
                                <option value="women" {{ ( $data->treatment_category == "women") ? 'selected' : '' }}>Women</option>
                                <option value="child" {{ ( $data->treatment_category == "child") ? 'selected' : '' }}>Child</option>
                            </select> 
                      ...
                      <div class="modal-footer center category-pop">
                         <button type="button" class="update-btn"  treatment-id ="{{ $data->id }}" data-dismiss="modal" aria-hidden="true">Add</button>
                         <button type="button" class="close-btn close close-button">Cancel</button>
...
<div class="upper_div lower_div"><h4>Estimated Time</h4><p class="price">{{ $data->treatment_hours }}:{{ $data->treatment_minute }}</p>
  <div class="otherPages" data-modal="modalten"><span class="icon"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div id="modalten" class="modal" style="display: none;">
            <div class="modal-dialog cate-box">
                <div class="modal-content">
                    <div class="modal-header header-top block">
                      <div class="popup-category">
                      ...
                      <div class="modal-footer center category-pop">
                         <button type="button" class="update-btn close close-button" data-dismiss="modal" aria-hidden="true">Delete</button>
                                          <button type="button" class="close-btn close close-button">Cancel</button>
                    </div>
...
<div id="modalnine_{{ $data->id }}" class="modal" style="display: none;">
  ...
  <div class="upper_div lower_div"><h4>Estimated Time</h4><p class="price">{{ $data->treatment_hours }}:{{ $data->treatment_minute }}</p><div class="otherPages" data-modal="modalten"><span class="icon"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M5.4375 1.6875H5.25C5.35313 1.6875 5.4375 1.60312 5.4375 1.5V1.6875H12.5625V1.5C12.5625 1.60312 12.6469 1.6875 12.75 1.6875H12.5625V3.375H14.25V1.5C14.25 0.672656 13.5773 0 12.75 0H5.25C4.42266 0 3.75 0.672656 3.75 1.5V3.375H5.4375V1.6875ZM17.25 3.375H0.75C0.335156 3.375 0 3.71016 0 4.125V4.875C0 4.97813 0.084375 5.0625 0.1875 5.0625H1.60312L2.18203 17.3203C2.21953 18.1195 2.88047 18.75 3.67969 18.75H14.3203C15.1219 18.75 15.7805 18.1219 15.818 17.3203L16.3969 5.0625H17.8125C17.9156 5.0625 18 4.97813 18 4.875V4.125C18 3.71016 17.6648 3.375 17.25 3.375ZM14.1398 17.0625H3.86016L3.29297 5.0625H14.707L14.1398 17.0625Z" fill="#BE0404"></path>
  </svg>
  </span>
</div>
