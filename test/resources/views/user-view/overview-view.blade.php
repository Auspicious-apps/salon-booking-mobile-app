    ...
    <div class="staff-block">
      ...
      <div class="metting-schedule overview">
        ...
        <div class="date">
          ...
          <input  class="calender" type="date" id="overview_startcustomerCalender" name="calender">
          <input  class="calender" type="date" id="overview_endcustomerCalender" name="calender">
          <button class="search-btn" id="filter_overviewCustomerData">Search</button>
        ...
        <table>
          ...
          <tr class="heading">
           ...
           @if(!empty($getCustomerData))
             @foreach($getCustomerData as $data)
              <tr>
                <td> {{ $data->appointment_no }}</td>
                <td>{{  $data->customer_name }}</td>
                <td> {{  $data->customerTime }} on {{  $data->customerDate }}</td>
                <td>{{  $data->appointedHairdresser }}</td>
              </tr>
           @endforeach
          @endif
