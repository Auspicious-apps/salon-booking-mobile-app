...
<head>
  ...
  <style> 
    #google_translate_element { height: 32px !important; overflow: hidden !important; }
...
<script src="{{ asset('dist/js/tabbing.js') }}"></script>
...
<script type="text/javascript">
   ...
   <script>
                ...
                $(".remove_image_icon").click(function() {
      ...
      $(document).ready(function(){
               ...
               $.ajaxSetup({
                ...
                $('.insert-treatment').click(function() {
                
                       var salooncategory  =  $("#salooncategory option:selected").val();
                       var saloon_treatment  =  $("#saloon_treatment").val();
                        var staff_member_id  =  $("#staff_member_id").val();
                       var price  =  $("#price").val();
                       var set_hours  =  $("#set_hours").val();
                       var set_minute  =  $("#set_minute").val();
                      // alert(staff_member_id);
                        if(salooncategory == ''){
                            alert('please select a category option!');
                            return false;
                       } else if(saloon_treatment=='') {
                            alert('please filled the saloon treatment field!');
                            return false;
                        } else if(staff_member_id=='') {
                            alert('please select a category option!');
                            return false;    
                       } else if(price=='') {
                            alert('please filled the price field!');
                            return false;
                       } else if(set_hours=='') {
                            alert('please filled the set hours field!');
                            return false;
                       } else if(set_minute=='') {
                           
                           alert('please filled the  minute field!');
                           return false;
                       } else {
                             $('.insert-treatment').prop('disabled', true);
                           
                            $.ajax({
                                    type:'POST',
                                    url:"{{ url('add-treatment-category') }}",
                                    data:{salooncategory:salooncategory,saloon_treatment:saloon_treatment,staff_member_id:staff_member_id,price:price,set_hours:set_hours,set_minute:set_minute},
                                        success:function(data){
                                    
                                            $('.insert-treatment').prop('disabled', false);
                                            swal("Treatment Added!", "success");

                                              $("#saloon_treatment").val('');
                                               $("#staff_member_id").val('');
                                              $("#price").val('');
                                              $("#set_hours").val('');
                                              $("#set_minute").val('');
                                           ...
                                           setTimeout(function() {
                                                      ...
                                                      if(url == 'https://www.mi-salon.es/get-salon') {
  ...
  <script type="text/javascript">
    ...
    setTimeout(function() {
              ...
              if(url == 'https://www.mi-salon.es/get-salon?single') {

                   $('.filters-content').find('.filter_1').removeClass('is-active');
                    $('.filters-content').find('.filter_2').addClass('is-active');

                      $('.filters').find('#salon').removeClass('is-active');
                        $('.filters').find('#treatments').addClass('is-active');
              } else {
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.delete-treatment-id').click(function(){

                    var delete_treatment_id  = $(this).attr("delete-treatment-id");

                      $.ajax({
                          type:'POST',
                          url:"{{ url('delete-treatment-category') }}",
                          data:{delete_treatment_id:delete_treatment_id},
                              success:function(data){
                              
                                   $("#modalnine_"+data).css("display", "none");
                                    swal("Treatment Deleted!", "success");
       ...
       $(document).ready(function(){
               ...
               $.ajaxSetup({
                ...
                $('.update-btn').click(function() {
                        ...
                        var current_id  =  $(this).attr('treatment-id');
                         
                        var treatment_name   = $('#treatment_name-'+current_id).val();
                        var salooncategory   = $('#salooncategory-'+current_id).val();
                        var treatment_rate   = $('#treatment_rate-'+current_id).val();
                        var treatment_hours   = $('#treatment_hours-'+current_id).val();
                        var treatment_minute   = $('#treatment_minute-'+current_id).val();
                          ...
                          if(salooncategory == ''){
                           ...
                           return false;
                              ...
                              $.ajax({
                                    type:'POST',
                                    url:"{{ url('udpate-treatment-category') }}",
                                    data:{current_id:current_id,treatment_name:treatment_name,salooncategory:salooncategory,treatment_rate:treatment_rate,treatment_hours:treatment_hours,treatment_minute:treatment_minute},
                                        success:function(data){
                                               $("#modalnine_"+data).css("display", "none");
                                                swal("Treatment Update!", "success");
  ...
  <script>
        ...
        $(document).on("change" , "#colorpicker_value" , function(){
            $('#test').val($(this).val());
            alert($(this).val());
  ...
  <script>
      ...
      $(document).on("click" , ".add_expenses" , function() {
                ...
                var expenses_calender = $('.expenses_calender').val();
                var expenses_Position = $('.expenses_Position').val();
                var expenses_amount = $('#expenses_amount').val();
                
                
                if ( expenses_calender == '') { 
                    
                    alert('please select the calender field!');
                    return false;
                    
                } else if(expenses_Position == '') {
                    
                    alert('please select the  field!'); 
                    return false;
                    
                } else if(expenses_amount == '') {
                    alert('please filled the amount field!'); 
                    return false;
                    
                } else {
                         $('.add_expenses').prop('disabled', true);
                    
                       $.ajax({
                        type:'POST',
                        url:"{{ url('overview-add-expenses') }}",
                        data:{expenses_calender:expenses_calender,expenses_Position:expenses_Position,expenses_amount:expenses_amount},
                            success:function(data){
                                $('.add_expenses').prop('disabled', false);
                                
                                        swal("Expenses Added!", "success");
                                        $("#modaltwo").css("display", "none");
                                        $(".expenses_calender").val('');
                                        $(".expenses_Position").val('');
                                        $("#expenses_amount").val('');
                                    
                                        
                                         setTimeout(function(){
                                                
                                                    window.location = '{{ url('get-overview-expenses') }}'
          ...
          $(document).on("click" , "#expenses_search" , function() {
             ...
             var expenses_Start_calenderDate = $('#expenses_Start_calenderDate').val();
                var expenses_End_calenderDate = $('#expenses_End_calenderDate').val();
                 ...
                 var dateArs = expenses_Start_calenderDate.split('-');
            expenses_Start_calenderDate = dateArs[2] + '-' + dateArs[1] + '-' + dateArs[0];
           
            var dateAre = expenses_End_calenderDate.split('-');
            expenses_End_calenderDate = dateAre[2] + '-' + dateAre[1] + '-' + dateAre[0];
                ...
                if ( expenses_Start_calenderDate == '') { 
                    ...
                    $('#expenses_search').prop('disabled', true);
                    $.ajax({
                        type:'POST',
                        url:"{{ url('overview-filerdata-expenses') }}",
                        dataType: 'json',
                        ...
                        beforeSend: function() {
                            ...
                            success:function(data){
                                ...
                                var output = '';
                                output += '<li class="heading"><span>Expense</span><span>Amount</span></li>';
                                output +='<li><span>Rent</span><span>€'+' '+parseFloat(data.rent).toFixed(2)+'</span></li>';
                                output +='<li><span>Products</span><span>€'+' '+parseFloat(data.products).toFixed(2)+'</span></li>';
                                output +='<li><span>others</span><span>€'+' '+parseFloat(data.others).toFixed(2)+'</span></li>';
                                // output +='<li><span>Appointments</span><span>€'+' '+parseFloat(data.appointments).toFixed(2)+'</span></li>';
                                output +='<li><span>inventory</span><span>€'+' '+parseFloat(data.inventory).toFixed(2)+'</span></li>';
                                output +='<li><span>standard monthly payments</span><span>€'+' '+parseFloat(data.standard_monthly_payments).toFixed(2)+'</span></li>';
                                output +='<li><span>Marketing Costs</span><span>€'+' '+parseFloat(data.marketing_costs).toFixed(2)+'</span></li>';
                                output +='<li><span>Food Drinks</span><span>€'+' '+parseFloat(data.Food_drinks).toFixed(2)+'</span></li>';
                                output +='<li><span>Subscription Costs</span><span>€'+' '+parseFloat(data.subscription_costs).toFixed(2)+'</span></li>';

                                $('.filter-expenses').html(output);
                                                                     
                                 $('#filter-total-expense').html('<span>€</span>'+' '+parseFloat(data.total_expenses).toFixed(2));
                                
                                $('#expenses_search').prop('disabled', false);
    ...
    <!-- start income -->
     ...
     <script>
      ...
      $(document).on("click" , ".add_income" , function(){
                ...
                var income_calender = $('.income_calender').val();
                var income_Position = $('.income_Position').val();
                ...
                } else if(income_Position == '') {
                    
                    alert('please select the  field!'); 
                    return false;
                    
                } else if(income_amount == '') {
                    alert('please filled the amount field!'); 
                    return false;
                    
                } else {
                         $('.add_income').prop('disabled', true);
                    
                       $.ajax({
                        type:'POST',
                        url:"{{ url('overview-add-income') }}",
                        data:{income_calender:income_calender,income_Position:income_Position,income_amount:income_amount},
                            success:function(data){
                              
                                $('.add_income').prop('disabled', false);
                                
                                        swal("income Added!", "success");
                                        $("#modaltwo").css("display", "none");
                                        $(".income_calender").val('');
                                        $(".income_Position").val('');
                                        $("#income_amount").val('');
                                         ...
                                         setTimeout(function(){
                                                    ...
                                                    window.location = '{{ url('get-overview-income') }}'
  ...
  <script>
          ...
          $(document).on("click" , "#income_search" , function() {
             ...
             var income_Start_calenderDate = $('#income_Start_calenderDate').val();
                var income_End_calenderDate = $('#income_End_calenderDate').val();

                  var dateArs = income_Start_calenderDate.split('-');
            income_Start_calenderDate = dateArs[2] + '-' + dateArs[1] + '-' + dateArs[0];
           
            var dateAre = income_End_calenderDate.split('-');
            income_End_calenderDate = dateAre[2] + '-' + dateAre[1] + '-' + dateAre[0];
            
                if ( income_Start_calenderDate == '') { 
                    
                    alert('please select the  calender field!');
                    return false;
                    
                } else if(income_End_calenderDate == '') {
                    ...
                    $('#income_search').prop('disabled', true);
                    $.ajax({
                        type:'POST',
                        url:"{{ url('overview-filerdata-income') }}",
                        dataType: 'json',
                        data:{income_Start_calenderDate:income_Start_calenderDate,income_End_calenderDate:income_End_calenderDate},
                        beforeSend: function() {
                            $("#loading-image").show();
                        },
                            success:function(data){
                               // alert(data);
                                ...
                                $('#income_Start_calenderDate').val('');
                                $('#income_End_calenderDate').val('');
                                var output = '';
                                output += '<li class="heading"><span>income</span><span>Amount</span></li>';
                                // output +='<li><span>Rent</span><span>€'+' '+parseFloat(data.rent).toFixed(2)+'</span></li>';
                                output +='<li><span>Products</span><span>€'+' '+parseFloat(data.products).toFixed(2)+'</span></li>';
                                output +='<li><span>others</span><span>€'+' '+parseFloat(data.others).toFixed(2)+'</span></li>';
                                output +='<li><span>Appointments</span><span>€'+' '+parseFloat(data.appointments).toFixed(2)+'</span></li>';
                                output +='<li><span>Donations</span><span>€'+' '+parseFloat(data.donations).toFixed(2)+'</span></li>';
                                output +='<li><span>Marketing</span><span>€'+' '+parseFloat(data.marketing).toFixed(2)+'</span></li>';
                                $('.filter-income').html(output);
                                                                     
                                 $('#filter-total-income').html('<span>€</span>'+' '+parseFloat(data.total_income).toFixed(2));
                                
                                $('#income_search').prop('disabled', false);
    ...
    <script>
          ...
          $(document).on("click" , "#filter_overviewCustomerData" , function() {
                
            var overview_startcustomerCalender = $('#overview_startcustomerCalender').val();
            var overview_endcustomerCalender = $('#overview_endcustomerCalender').val();

            // startcustomerCalender = moment(overview_startcustomerCalender).format('YYYY-DD-MM');
            // overview_endcustomerCalender = moment(overview_endcustomerCalender).format('YYYY-DD-MM');

            var dateArs = overview_startcustomerCalender.split('-');
            overview_startcustomerCalender = dateArs[2] + '-' + dateArs[1] + '-' + dateArs[0];
           
            var dateAre = overview_endcustomerCalender.split('-');
            overview_endcustomerCalender = dateAre[2] + '-' + dateAre[1] + '-' + dateAre[0];

                if ( overview_startcustomerCalender == '') { 
                    
                    alert('please select the  calender field!');
                    return false;
                    
                } else if(overview_endcustomerCalender == '') {
                    ...
                    $('#filter_overviewCustomerData').prop('disabled', true);
                    $.ajax({
                        type:'POST',
                        url:"{{ url('overview-customerfilerdata') }}",
                        //dataType: "json",
                        data:{overview_startcustomerCalender:overview_startcustomerCalender,overview_endcustomerCalender:overview_endcustomerCalender},
                      
                            success:function(data){
                              // alert(data);
                               $('.total_balance_period').text(parseFloat(data).toFixed(2));
                               $('#filter_overviewCustomerData').prop('disabled', false);
...
$("#test").click(function(){
  ...
  // function me(){
  //           var date = $('#calender').datepicker('getDate');
  //           alert(date);
  //           return false;
  //           var dateString = $.datepicker.formatDate("dd-mm-yy", date);
  //           var url = "{{route('user', '')}}"+"/"+dateString;
...
<!-- change selected categoies on based on gender -->

  <script type="text/javascript">
        
      
      $(document).on("change" , ".selectedGenerCategories" , function() {

            var checkselectedvalue = $( ".selectedGenerCategories" ).val();

            //  alert(checkselectedvalue);

              $.ajax({
                type:'POST',
                url:"{{ url('get-selectedCategoriesGender') }}",
                data:{checkselectedvalue:checkselectedvalue},
                    success:function(data){
                         // alert(JSON.stringify(response));
                         $('.select1').empty();
                          $.each(data.getservcies,function(index,getservcies){
                            //alert(JSON.stringify(getservcies));
                            $('.select1').append('<option value="'+getservcies.id+'">'+getservcies.treatment_name+'</option>');

                      });

                  // $.each(response.states, function (i, state) {
                  // $('#appointmen-services').append('<option value="' + state.id + '">' + state.id + '</option>');
...
$(document).on("click" , "#appointmen-services" , function() {

  
      var checkselectedeprice = $( "#appointmen-services" ).val();


      if (checkselectedeprice != '') {

          //alert(checkselectedeprice);
        $.ajax({
                type:'POST',
                url:"{{ url('get-selectedCategoriesPrice') }}",
                dataType: 'JSON',
                data:{checkselectedeprice:checkselectedeprice},
                    success:function(data){
                      $('.service_price_agenda').empty();
                          //  var jsonData = JSON.parse(response);
                           $.each(data.getservciesPrice,function(index,getservciesPrice){
                              //  alert(JSON.stringify(getservciesPrice));
                            //$('.service_price_agenda').text(getservciesPrice.treatment_rate);

                              $('.post_service_price_agenda').attr('value',getservciesPrice.treatment_rate);
                              $('.service_price_agenda').attr('value',getservciesPrice.treatment_rate);
                            // $(".service_price_agenda").val(getservciesPrice.treatment_rate);

                             $("#service_price_agenda_total").text(getservciesPrice.treatment_rate);
  ...
  $(function(){
  $('.appointment_input__item').datepicker({ 
     dateFormat: 'yy-mm-dd',
    showOtherMonths: true,
    showMonthAfterYear: true,  
    changeYear: true,
...
function checkForm() {
      ...
      var calender = document.getElementById("appointment_calender").value;
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   $(document).on("change" , "#appointment_calender" , function() {
        ...
        return false;
          ...
          var get_calender_Date = this.value;
         // return true;

           $.ajax({
                type:'POST',
                url:"{{ url('get-slot-booking') }}",
                dataType: 'JSON',
                data:{get_calender_Date:get_calender_Date},
                    success:function(data){
                       
                           $(".appointment-time").empty(); 
                        $('.label-booking-time').css('display','block');

                        var test = JSON.stringify(data.date);
                        var testsds =  test.replace(/"/g,'')
                      ...
                      var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
                        ...
                        if(new Date(testsds) >= new Date(date)) {
                          ...
                          if(payload.is_booked==false) {      
                            ...
                            $(".appointment-time").append('<input type="button" class="btn btn-info selected-appointment-timing" value='+payload.start_time+'>');
                   
                          } else {
                               
                               $(".appointment-time").append('<input type="button" class="btn btn-danger" value='+payload.start_time+' disabled>');

                          }


                          $('#outer-div-selected-time').css('display','block');
                            ...
                            $(".appointment-time").append('<input disabled type="button" class="btn btn-danger selected-appointment-timing" value='+payload.start_time+'>');
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   $(document).on("click" , ".selected-appointment-timing" , function() {


          var get_appointment_timing = this.value;

                if(get_appointment_timing != '') {
                  
                    $('#selected-apppointment-time').val(get_appointment_timing);
                     $('#hidden_selected_appointment_time').val(get_appointment_timing);
...
<script type="text/javascript">
  $(document).ready(function () {
     ...
     var table = $('#dtBasicExample').DataTable({
        pageLength : 5,
         "oLanguage": {
      "sLengthMenu": "Elige la  _MENU_ cantidad",
    },
         language: {
              "info": "Muestra _START_ á  _END_ de _TOTAL_ citas",
               "search": "Buscar:",
    paginate: {
      next: 'Próximo', 
      previous: 'Anterior'  
...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      var table = $('#dtBasicExample_test').DataTable({
      pageLength : 5,
            "oLanguage": {
      "sLengthMenu": "Elige la  _MENU_ cantidad",
    },
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
              ...
              $(document).on("change" , "#edit-dashboard-appointment" , function() {

                     var get_edit_dashboard_appointment = this.value;
                     //alert(get_edit_dashboard_appointment);

                      $.ajax({
                        type:'POST',
                        url:"{{ url('get-edit-dasbhoard-appointment-data') }}",
                        dataType: 'JSON',
                        data:{get_edit_dashboard_appointment:get_edit_dashboard_appointment},
                              ...
                              if(new Date(testsds) >= new Date(date)) {
                                ...
                                $.each(data.payload,function(index,payload) {
                                    ...
                                    if(payload.is_booked==false) {      
                                      ...
                                      $(".appointment-time").append('<button type="button" class="btn btn-info selected-appointment-timing" >'+payload.start_time+'</button');

                                    } else {
                                          
                                      $(".appointment-time").append('<button type="button" class="btn btn-danger" disabled>'+payload.start_time+' </button>');
                                ...
                                $.each(data.payload,function(index,payload){
                                $(".appointment-time").append('<button disabled type="button" class="btn btn-danger selected-appointment-timing" >'+payload.start_time+'</button>');
                                $('#outer-div-selected-time').css('display','block');
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
              ...
              $(document).on("change" , "#app_appointment_date" , function() {
    ...
    <!-- change app appointment time script -->

    <script type="text/javascript">
        $(document).ready(function(){

            $(document).on("click" , ".app-apt-timing" , function() {

                $('.selected-appointment-timing').removeClass('selected-time');
    ...
    <!-- change dashboard appointment time script -->

    <script type="text/javascript">
        $(document).ready(function(){

            $(document).on("click" , ".dash-apt-timing" , function() {
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
              ...
              $(document).on("click" , ".appointment_dashboard" , function() {

                      var dashbaord_appointment_id  =  $(this).attr('data-dashbaord-appointment');
              ...
              if (willDelete) {
                ...
                $.ajax({
                   ...
                   url:"{{ url('cancel-appointment-record') }}",
        
                   data:{dashbaord_appointment_id:dashbaord_appointment_id},
                   ...
                   success:function(data){
                    ...
                    setTimeout(function(){
                        ...
                        window.location = '{{ url('view-appointment') }}'
 ...
 <!-- cancel appointment script app -->
<script type="text/javascript">
  
    $(document).ready(function(){

              $(document).on("click" , ".appointment_app" , function() {

                      var app_appointment_id  =  $(this).attr('data-app-appointment');
              ...
              if (willDelete) {
                ...
                $.ajax({
                   ...
                   url:"{{ url('cancel-appointment-app-record') }}",
        
                   data:{app_appointment_id:app_appointment_id},
