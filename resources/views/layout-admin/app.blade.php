...
th,font::first-letter {
  text-transform: capitalize;
}
button,font::first-letter {
  text-transform: capitalize;
}
label::first-letter {
  text-transform: capitalize;
...
<script type="text/javascript">
      ...
      $(".changed_request_approvedStatus").click(function(){
        ...
        var changed_approved_status =  $(this).attr("changed-approved-status");
      ...
      swal({  
          ...
          dangerMode: true,
              ...
              $("#changed_request_approvedStatus-"+changed_approved_status).append('&nbsp;<i class="fa fa-refresh fa-spin"></i>');
              $('#changed_request_approvedStatus-'+changed_approved_status).prop('disabled', true);

                   $.ajax({
                      type:'POST',
                      url:"{{ url('changed-request-ApprovedStatus') }}",
                      data:{changed_approved_status:changed_approved_status},
                    
                    success:function(data){
                      
                      swal("Data Deleted!", "success");
                                
                          $('#changed_request_approvedStatus-'+changed_approved_status).prop('disabled', false);
                                   
                                    

                                  setInterval(function() {
                                        window.location.href = "/rejected-request";
                                }, 3000);
                                    swal("Saloon Rejected!", "success");
...
<script type="text/javascript">
   ...
   $(".changed_request_rejectedStatus").click(function() {
        ...
        var changed_rejected_status =  $(this).attr("changed-rejected-status");


           swal({  
          
          title: `Are you sure you to Approved this record?`,
          text: "If you delete this, it will be gone forever.",
          icon: "warning",
          buttons: true,  
          dangerMode: true,
              ...
              $("#changed_request_rejectedStatus-"+changed_rejected_status).append('&nbsp;<i class="fa fa-refresh fa-spin"></i>');
              $('#changed_request_rejectedStatus-'+changed_rejected_status).prop('disabled', true);

                   $.ajax({
                      type:'POST',
                      url:"{{ url('changed-request-RejectedStatus') }}",
                      data:{changed_rejected_status:changed_rejected_status},
                    
                    success:function(data){
                        
                      swal("Data Deleted!", "success");
                                
                          $('#changed_request_rejectedStatus-'+changed_rejected_status).prop('disabled', false);
                                  setInterval(function() {
                                        window.location.href = "/accepted-request";
                                }, 3000);
                                    swal("Saloon Accepted!", "success");
