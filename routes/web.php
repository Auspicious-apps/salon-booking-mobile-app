...
//sameer
Route::get('/admin/saloon/{id}', 'Admin\SalonController@saloon_id')->name('admin-saloon-id');
//sameer  


Route::get('/user-marketing', 'Admin\SalonController@index1')->name('user-marketing');

Route::get('/add-facebook-marketing', 'Admin\SalonController@add_facebook_marketing')->name('add-facebook-marketing');
Route::post('/send-add-facebook-data', 'Admin\SalonController@send_add_facebook_data')->name('send-add-facebook-data');
/* sameer filter date */
Route::get('/admin/{date}/{saloon_id}', 'Admin\SalonController@saloon_date')->name('date');
/* sameer  filter date*/
...
Route::post('/changed-request-ApprovedStatus', 'Admin\SalonController@changed_request_ApprovedStatus')->name('changed-request-ApprovedStatus');


Route::get('/rejected-request', 'Admin\SalonController@rejected_request')->name('rejected-request');
Route::post('/changed-request-RejectedStatus', 'Admin\SalonController@changed_request_RejectedStatus')->name('changed-request-RejectedStatus');
...
/* sameer */
Route::get('/user/{date}', 'User\UserController@saloon_date')->name('date');
/* sameer */ 


Route::get('/salon-new-appointment', 'User\UserController@salon_new_appointment')->name('salon-new-appointment');
...
Route::post('/delete-treatment-category', 'User\SalonTreatmentController@delete_treatment_category')->name('delete-treatment-category');
...
Route::get('/user-setting', 'User\UserController@user_setting')->name('user-setting');
Route::post('/user-setting', 'User\UserController@sendchangedpassword_user_setting')->name('user-setting');



// change categries of  new appoinemtn based on gender //

Route::post('/get-selectedCategoriesGender', 'User\UserController@get_selectedCategoriesGender')->name('get-selectedCategoriesGender');

Route::post('/get-selectedCategoriesPrice', 'User\UserController@get_selectedCategoriesPrice')->name('get-selectedCategoriesPrice');

Route::post('/post-new-appointment', 'User\UserController@post_newAppointment')->name('post-new-appointment');

Route::post('/get-slot-booking', 'User\UserController@get_slot_booking')->name('get-slot-booking');

// new appointment route listing

Route::get('/view-appointment', 'User\AppointmentController@index')->name('view-appointment');

Route::get('/dashboard-appointment/{id}', 'User\AppointmentController@dashboard_appointment')->name('dashboard-appointment');

Route::get('/edit-app-appointment/{userid}/{appointment_id}', 'User\AppointmentController@edit_app_appointment')->name('edit-app-appointment');

Route::post('/post-edit-appointment-form', 'User\AppointmentController@post_edit_appointment_form')->name('post-edit-appointment-form');

Route::post('/post-edit-app-appointment-form', 'User\AppointmentController@post_edit_app_appointment_form')->name('post-edit-app-appointment-form');


Route::post('/get-edit-dasbhoard-appointment-data', 'User\AppointmentController@get_edit_dasbhoard_appointment_data')->name('get-edit-dasbhoard-appointment-data');


Route::get('/rejected-appointment', 'User\AppointmentController@get_rejected_appointment')->name('rejected-appointment');


Route::post('/cancel-appointment-record', 'User\AppointmentController@cancel_appointment_record')->name('cancel-appointment-record');

Route::post('/cancel-appointment-app-record', 'User\AppointmentController@cancel_appointment_app_record')->name('cancel-appointment-app-record');

Route::post('/filter-overview-Appointmentdata', 'User\OverviewController@filter_overview_Appointmentdata')->name('filter-overview-Appointmentdata');
	//end route 
